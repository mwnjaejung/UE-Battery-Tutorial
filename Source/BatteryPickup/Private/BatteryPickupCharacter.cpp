...
void ABatteryPickupCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("TurnRate", this, &ABatteryPickupCharacter::TurnAtRate);
	InputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	InputComponent->BindAxis("LookUpRate", this, &ABatteryPickupCharacter::LookUpAtRate);

	// handle touch devices
	InputComponent->BindTouch(IE_Pressed, this, &ABatteryPickupCharacter::TouchStarted);
	InputComponent->BindTouch(IE_Released, this, &ABatteryPickupCharacter::TouchStopped);
}
